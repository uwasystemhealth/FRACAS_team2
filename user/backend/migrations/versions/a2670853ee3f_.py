...
Revision ID: a2670853ee3f
Revises: 
Create Date: 2023-09-22 09:11:21.821348
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['leader_id'], ['user.id'], name=op.f('fk_team_leader_id_user')),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('can_validate', sa.Boolean(), nullable=True),
    ...
    sa.Column('team_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['team_id'], ['team.id'], name=op.f('fk_subsystem_team_id_team')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_subsystem')),
    sa.UniqueConstraint('name', name=op.f('uq_subsystem_name'))
    )
    ...
    sa.Column('subsystem_name', sa.String(), nullable=True),
    ...
    sa.Column('marked_for_deletion', sa.Boolean(), server_default=sa.text('0'), nullable=False),
    sa.Column('time_resolved', sa.DateTime(), nullable=True),
    sa.Column('record_valid', sa.Boolean(), nullable=True),
    sa.Column('analysis_valid', sa.Boolean(), nullable=True),
    sa.Column('corrective_valid', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['creator_id'], ['user.id'], name=op.f('fk_record_creator_id_user'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['owner_id'], ['user.id'], name=op.f('fk_record_owner_id_user'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['subsystem_name'], ['subsystem.name'], name=op.f('fk_record_subsystem_name_subsystem')),
    sa.ForeignKeyConstraint(['team_id'], ['team.id'], name=op.f('fk_record_team_id_team'), ondelete='SET NULL'),
