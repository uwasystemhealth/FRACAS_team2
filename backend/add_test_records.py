...
with app.app_context():
    ...
    # List of subsystems
    subsystem_list = [
        Subsystem(subsystem = "PDM"),
        Subsystem(subsystem = "Battery Pack"),
        Subsystem(subsystem = "Transmission"),
        Subsystem(subsystem = "Front Wing"),
        Subsystem(subsystem = "Rear Suspension")
    ]
